    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            {isLoading ? "Please wait while we verify your email..." : "Verification complete"}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className={`text-center text-sm ${message.includes("successfully") ? "text-primary" : "text-destructive"}`}>
              {message}
            </p>
          </div>
        </CardContent>
